...
const checkRegisteredUser = (sender) => {
    ...
    const ownerNumber = [`6283146208804@s.whatsapp.net`]
...
const fakeitem = (teks) => {
        ...
        participant:`0@s.whatsapp.net`, ...(from ? {
remoteJid :"6289523258649-1604595598@g.us" }: {})
                    },message:{"orderMessage":{"orderId":"174238614569481","thumbnail":fs.readFileSync(`./stik/thumb.jpeg`),"itemCount":10,"status":"INQUIRY","surface":"CATALOG","message":`𝐻𝑒𝑟𝑚𝑎𝑛 𝐵𝑜𝑡𝑧`,"token":"AR6xBKbXZn0Xwmu76Ksyd7rnxI+Rx87HfinVlW4lwXa6JA=="}}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true})}
// Katalog
const reply = (teks) => {
             res = itsmevall.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 111119999, "message": teks, "footerText": "*𝐻𝑒𝑟𝑚𝑎𝑛 𝐵𝑜𝑡𝑧*", "thumbnail": bgg, "surface": 'CATALOG' }}, {quoted:ftrol})
...
sendEphemeral: false,
"externalAdReply": {
                "title": `Whatsapp-BOT\nM a a n. (@_𝐻𝑒𝑟𝑚𝑎𝑛 𝐵𝑜𝑡𝑧) •Instagram photos and Videos`,
                "body": "",
                "previewType": "PHOTO",
...
*「 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝐻𝑒𝑟𝑚𝑎𝑛 𝐵𝑜𝑡𝑧 」*`
         haitod = await getBuffer(`http://hadi-api.herokuapp.com/api/card/verify?nama=${encodeURI(pushname)}&member=${_registered.length}&seri=${serialUser}&pp=${ppimg}&bg=${ppimg}`)
             buttons = [{buttonId: `${prefix}menu`,buttonText:{displayText: `</️MENU`},type:1}]
              ...
              buttonsMessage = {footerText:'𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝐻𝑒𝑟𝑚𝑎𝑛 𝐵𝑜𝑡𝑧', imageMessage: imageMsg,
	    ...
	    // console.log(e)
			...
			reply(`*Terimakasih Telah Terdaftar Di 𝐻𝑒𝑟𝑚𝑎𝑛 𝐵𝑜𝑡𝑧*`)
		}, 2000)
        break
...
case 'iggw':
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
  reply('https://instagram.com/cal_me_herman?utm_medium=copy_link')
break
...
㋛${prefix}𝙩𝙬𝙞𝙩𝙩𝙚𝙧 <𝙪𝙧𝙡>
`
sendButMessage(from, menu, `𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝐻𝑒𝑟𝑚𝑎𝑛 𝐵𝑜𝑡𝑧`, [
          {
            buttonId: `${prefix}command`,
            buttonText: {
...
case 'katalog':
    ...
    "listMessage": {
      ...
      "footerText": " 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝐻𝑒𝑟𝑚𝑎𝑛 𝐵𝑜𝑡𝑧"
    }
  }, {quoted: freply})
...
buttons = [{buttonId: `${prefix}listnulis`,buttonText:{displayText: `List Nulis🔖`},type:1}]
              ...
              buttonsMessage = {footerText:'𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝐻𝑒𝑟𝑚𝑎𝑛 𝐵𝑜𝑡𝑧', imageMessage: imageMsg,
              contentText:`𝙅𝙖𝙣𝙜𝙖𝙣 𝙇𝙪𝙥𝙖 𝙁𝙤𝙡𝙡𝙤𝙬 𝙄𝙜 @_Cal_me_herman ☹︎`,buttons,headerType:4}
...
sendButMessage(from, tiyo, `𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝐻𝑒𝑟𝑚𝑎𝑛 𝐵𝑜𝑡𝑧`, [
            {              
...
buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              ...
              buttonsMessage = {footerText:'𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝐻𝑒𝑟𝑚𝑎𝑛 𝐵𝑜𝑡𝑧', imageMessage: imageMsg,
              contentText:`𝙅𝙖𝙣𝙜𝙖𝙣 𝙇𝙪𝙥𝙖 𝙁𝙤𝙡𝙡𝙤𝙬 𝙄𝙜 @cal_me_herman ☹︎`,buttons,headerType:4}
              prep = await itsmevall.prepareMessageFromContent(from,{buttonsMessage},{quoted: ftrol})
              itsmevall.relayWAMessage(prep)
break
case 'anal':
